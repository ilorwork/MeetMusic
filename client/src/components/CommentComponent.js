        ...
        <>
            <Box sx={{
                ...
                >
                    ...
                    >
                        <Typography color={"blue"}>{isCommentToCommentOpen ? "Hide reply's option" : "Reply to comment"}</Typography>
                    </MenuItem>
                </Menu>
            </Box>
            ...
            {isCommentToCommentOpen && <CreateCommentToComment
                ...
                setCommentsToCommentCount={setCommentsToCommentCount} paddingXForCommentToComment={paddingXSourceForCommentToComment} />}
            {isCommentToCommentOpen &&
                commentsOfComment.map((commentToComment) => <CommentToCommentComponent
                    commentToComment={commentToComment} comment={comment}
                    getCommentsOfComment={getCommentsOfComment} commentsToCommentCount={commentsToCommentCount}
                    setCommentsToCommentCount={setCommentsToCommentCount}
                    paddingXForCommentToComment={paddingXSourceForCommentToComment} key={uuid()} />)}
        </>
    )
}
